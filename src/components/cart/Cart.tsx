...
function Cart() {
  ...
  //check if size is selected for all products in the cart
  let cartItems = 0;
  let cartColors = 0;
  ...
  function checkSize() {
    cartItems = 0; // Reset cartItems count
    cartColors = 0;
    ...
    if (cartItems !== cart.length) {
      toast.error("Please select size for all products in the cart", {
        position: "top-right",
        autoClose: 5000,
    ...
    if (cartColors !== cart.length) {
      toast.error("Please select color for all products in the cart", {
        position: "top-right",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
            ...
            <div className="md:hidden flex justify-center items-center ">
              <Button
                onClick={() => {
                  ...
                  if (sizeCheck && totalCartQuantity > 0) {
