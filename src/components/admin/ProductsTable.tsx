        ...
        .map((product) => {
          ...
          return (
            <div
              ...
              className="grid grid-cols-6 min-w-[120rem] lg:w-full gap-x-4 gap-y-2 justify-items-center cursor-pointer bg-gray-200 my-[2rem] py-[1rem] rounded-2xl relative"
            >
