...
import { getOrders, getTotalSales } from "../../../utils/placeOrder";
  ...
  return (
    <div className="mt-[4rem]">
      ...
      <div className="flex flex-col items-center md:flex-row md:justify-center gap-y-[2rem] md:gap-x-[10rem] ">
        <HotProductCard label={"Total Sales"} number={totalSales} Id={1} />
        <HotProductCard label={"Total Orders"} number={totalOrders} Id={2} />
